...
void main() {
  ...
  testWidgets('VerticalProductList displays products',
  ...
  testWidgets('VerticalProductList displays add to cart interaction',
      (WidgetTester tester) async {
    when(() => cartViewModel.isProductAdded(any())).thenReturn(false);
  ...
  testWidgets('VerticalProductList remove from cart interaction',
      (WidgetTester tester) async {
  ...
  testWidgets('VerticalProductList buy interaction',
      (WidgetTester tester) async {
    when(() => cartViewModel.isProductAdded(any())).thenReturn(true);
  ...
  testWidgets('VerticalProductList tap interaction',
      (WidgetTester tester) async {
    when(() => cartViewModel.isProductAdded(any())).thenReturn(true);
