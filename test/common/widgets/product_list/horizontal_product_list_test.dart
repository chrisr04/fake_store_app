...
void main() {
  ...
  testWidgets('HorizontalProductList displays products',
  ...
  testWidgets('HorizontalProductList displays add to cart interaction',
      (WidgetTester tester) async {
    when(() => cartViewModel.isProductAdded(any())).thenReturn(false);
  ...
  testWidgets('HorizontalProductList remove from cart interaction',
      (WidgetTester tester) async {
  ...
  testWidgets('HorizontalProductList buy interaction',
      (WidgetTester tester) async {
    when(() => cartViewModel.isProductAdded(any())).thenReturn(true);
  ...
  testWidgets('HorizontalProductList tap interaction',
      (WidgetTester tester) async {
    when(() => cartViewModel.isProductAdded(any())).thenReturn(true);
    ...
    await tester.tap(find.byType(FakeProductCard).first);
